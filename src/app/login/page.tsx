...
export default function LoginPage() {
  ...
  */
  ...
  /*
    ...
    email:
    guarda o que o usuário digitou no campo de email

    senha:
    guarda o que o usuário digitou no campo de senha

    erro:
    guarda a mensagem de erro que vamos mostrar na tela

    mostrarSenha:
    controla se o campo de senha aparece visível ou escondido
  */
  ...
  /*
    ...
    Validação simples:
    - não deixa campo vazio
    - verifica se o email tem "@"

    Se estiver tudo certo:
    - limpa o erro
    - navega para /operacao
  */
        ...
        >
          ...
          <circle cx="12" cy="12" r="3" />
              ...
              <p className="mt-6 text-sm text-neutral-500">
                Nesta etapa, o login ainda é visual. Depois a gente liga com
                autenticação real.
              </p>
            </div>
          </section>
